cordova.define('cordova/plugin_list', function(require, exports, module) {
  module.exports = [
    ...
    {
      "id": "cordova-plugin-server.CreateServer",
      "file": "plugins/cordova-plugin-server/www/server.js",
      "pluginId": "cordova-plugin-server",
      "clobbers": [
        "window.CreateServer"
      ]
    },
    ...
    {
      "id": "cordova-plugin-sftp.sftp",
      "file": "plugins/cordova-plugin-sftp/www/sftp.js",
      "pluginId": "cordova-plugin-sftp",
      "clobbers": [
        "window.sftp"
      ]
    },
    {
      "id": "com.foxdebug.acode.rk.exec.terminal.Terminal",
      "file": "plugins/com.foxdebug.acode.rk.exec.terminal/www/Terminal.js",
      "pluginId": "com.foxdebug.acode.rk.exec.terminal",
      "clobbers": [
        "window.Terminal"
      ]
    },
    {
      "id": "com.foxdebug.acode.rk.exec.terminal.Executor",
      "file": "plugins/com.foxdebug.acode.rk.exec.terminal/www/Executor.js",
      "pluginId": "com.foxdebug.acode.rk.exec.terminal",
      "clobbers": [
        "window.Executor"
      ]
    ...
    {
      "id": "com.foxdebug.acode.rk.plugin.plugincontext.PluginContext",
      "file": "plugins/com.foxdebug.acode.rk.plugin.plugincontext/www/PluginContext.js",
      "pluginId": "com.foxdebug.acode.rk.plugin.plugincontext",
      "clobbers": [
  ...
  module.exports.metadata = {
    ...
    "cordova-plugin-server": "1.1.1",
    "cordova-plugin-ftp": "1.1.1",
    "cordova-plugin-sdcard": "0.0.1",
    "cordova-plugin-advanced-http": "3.3.1",
    "cordova-plugin-websocket": "0.0.1",
    "cordova-plugin-buildinfo": "4.0.0",
    "cordova-plugin-browser": "1.0.0",
    "cordova-plugin-sftp": "1.1.1",
    "com.foxdebug.acode.rk.exec.terminal": "1.0.0",
    "com.foxdebug.acode.rk.plugin.plugincontext": "1.0.0",
    "cordova-plugin-system": "0.0.1",
    "com.foxdebug.acode.rk.auth": "1.0.0",
    "com.foxdebug.acode.rk.exec.proot": "1.0.0",
    "cordova-plugin-iap": "0.0.1",
    "com.foxdebug.acode.rk.customtabs": "1.0.0"
  };
});